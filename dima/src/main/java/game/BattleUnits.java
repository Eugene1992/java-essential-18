...
public class  BattleUnits {
    ...
    public  static  int getRndStrength (int minStrength , int maxStrength) {return getRndNum(minStrength, maxStrength);}
    public static int getChanceBlockAttack (int percent) {return getRndNum(0, 100); }
    public static int getChanceCriticalDmg () {return getRndNum(0, 10);}
