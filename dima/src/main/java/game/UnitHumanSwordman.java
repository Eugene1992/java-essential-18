...
public class UnitHumanSwordman extends Hero  {
    ...
    public UnitHumanSwordman(String name, int hp, int armor, int minStrength, int maxStrength, int weponsDmg) {super (name, hp, armor, minStrength, maxStrength, weponsDmg);
    }
