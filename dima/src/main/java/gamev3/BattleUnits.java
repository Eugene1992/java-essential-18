...
public class BattleUnits {
    ...
    public static double getRndStrength(double minStrength, double maxStrength) {
        return getRndNum(minStrength, maxStrength);
    }

    public static double getRndArrayHeroIndex(Hero[] heroes) {
        return getRndNum(0, heroes.length - 1);
    }
